  ...
  <div class="modal-dialog cascading-modal modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-c-tabs">
                                    ...
                                    <div class="row">
                                        <div class="d-flex justify-content-center mb-3">
                                            <div class="image-upload">
                                                ...
                                                <% if(((Usuario) session.getAttribute("usuario")).getFoto() != null) { 
                                                	out.println("<img class=\"img-fluid\" src=\"" + ((Usuario) session.getAttribute("usuario")).getFoto() +"\">");
                                                } else {
        ...
        <script src="https://app.simplefileupload.com/buckets/e40aa9a56ba370494194878a3b4eb478.js"></script>
    </body>
