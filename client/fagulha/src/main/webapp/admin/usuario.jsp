      ...
      <section id="faq" class="faq mt-5">
        <div class="container aos-init aos-animate" data-aos="fade-up">
          ...
          <table class="table denuncia-table pb-3">
            ...
            <tbody>
            	<%
            		if((List<Usuario>) session.getAttribute("usuarios") != null) {
            					int index = 0;
            	                    	for(Usuario u : (List<Usuario>) session.getAttribute("usuarios")) {
            	                    		index += 1;
            	                    		out.println("<tr>");
            	                    		out.println("<th scope=\"row\">" + index + "</th>");
            	                        	out.println("<td>" + u.getNome() + "</td>");
            	                        	out.println("<td>" + u.getEmail() + "</td>");
            	                        	out.println("<td>" + u.getCidade() + "</td>");
            	                        	out.println("<td>" + u.getEstado() + "</td>");
            	                        	out.println("<td>" + u.getPais() + "</td>");
            	                        	out.println("<td>" + new Conversor().getDate(u.getDataNasc()) + "</td>");
            	                        	out.println("<td><p>" + u.getCpf() + "</p></td>");
            	                        	out.println("</tr>");
            	                	}
            	                }
            	%>
